...
- `LAN DNS` — настройка `dnsmasq`, то есть куда роутер отправляет DNS-запросы телефонов, ПК и других домашних устройств;
...
- `Внешний DNS / Pi-hole`: домашние устройства спрашивают DNS у роутера, а роутер пересылает запросы на указанный Pi-hole или внешний DNS;
