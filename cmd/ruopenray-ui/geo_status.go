...
func (s *serverState) geoStatus() map[string]any {
	...
	return map[string]any{
		"ok": true, "dir": s.cfg.GeoDir, "disk": rsystem.DiskInfo(s.cfg.GeoDir), "presets": visibleGeoPresets(), "extras": extras, "files": s.geoInstalledFiles(), "customSources": s.geoCustomSources(),
