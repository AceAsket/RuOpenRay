const busyLabels = {
  ...
  refreshCompatibility: 'Обновляю совместимость',
  refreshServerMode: 'Обновляю входящие подключения',
  addServerModeXrayInbound: 'Добавляю вход Xray',
  addServerModeClient: 'Добавляю клиента',
  addServerModeAWGServer: 'Добавляю сервер AWG',
  addServerModeAWGPeer: 'Добавляю peer AWG',
  generateServerModeAWGServerKey: 'Создаю ключи AWG-сервера',
  generateServerModeAWGPeerKey: 'Создаю ключи AWG-клиента',
  exportServerModeAWGPeer: 'Готовлю client.conf',
  downloadServerModeAWGClientExport: 'Скачиваю client.conf',
  ...
  applyServerModeFirewall: 'Открываю WAN-порты',
  disableServerModeFirewall: 'Закрываю WAN-порты',
  applyServerModeAWGRuntime: 'Запускаю AWG server',
  disableServerModeAWGRuntime: 'Останавливаю AWG server',
  applyServerMode: 'Записываю server-mode в Xray',
  deleteServerModeInbound: 'Удаляю вход',
  deleteServerModeClient: 'Удаляю клиента',
  deleteServerModeAWGServer: 'Удаляю сервер AWG',
  deleteServerModeAWGPeer: 'Удаляю peer AWG',
  refreshAmnezia: 'Обновляю AmneziaWG',
  loadAmneziaConfig: 'Загружаю конфиг AmneziaWG',
  saveAmneziaConfig: 'Сохраняю конфиг AmneziaWG',
  ...
  applyAmneziaPolicy: 'Применяю AmneziaWG policy',
  rollbackAmneziaPolicy: 'Откатываю AmneziaWG policy',
  ...
  checkAndStartAmnezia: 'Проверяю и запускаю AmneziaWG',
