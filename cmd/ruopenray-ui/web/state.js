...
export function createInitialState() {
  ...
  firewallKillSwitchDeviceMode: localStorage.getItem(firewallKillSwitchDeviceModeStorageKey) || 'all',
  firewallKillSwitchSelectedDevices: loadStringListStorage(firewallKillSwitchSelectedDevicesStorageKey),
  ...
  firewallDnsIntercept: localStorage.getItem(firewallDnsInterceptStorageKey) !== '0',
